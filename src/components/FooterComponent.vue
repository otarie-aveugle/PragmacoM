  ...
  <footer
    ...
    <div class="mx-4 text-left">
      <ul class="menu menu-vertical md:menu-horizontal md:gap-x-6">
        ...
        <RouterLink v-if="!userLoggedIn" to="/login" class="link link-hover text-lg">
          <li>Connexion</li>
        </RouterLink>
        <button v-else type="button" class="link link-hover text-lg" onclick="logoutModal.showModal()">
          <li>Déconnexion</li>
        </button>
      </ul>
    </div>
